...
<br />
9. Go to the ViewController.swift file, add the asset ID's for 3D content you have added to your echo3D console where it says "insert asset ID here".
10. Connect your iPhone/iPad to computer.
11. Select your device on the dropdown list of devices to run the demo app on.
12. Press the Play button to build and run (Note: your device must be unlocked and in Developer Mode to run).
